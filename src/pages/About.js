    ...
    <Container style={{ minHeight: "100vh" }}>
      <div className="wrapper">
        ...
        <p classname="text">
          ...
          <div class="generic-about-us"></div>
            ...
            <Row>
              <Col className="col-left">
                <p classname="text">
                  ...
                  manager, turnerings admin, og caster, samt caster og admin
                  inden for flere danske Rocket League cups bl.a. Yousee
                  Esportligaen, OACES og Nordic Championship i Rocket League.
                </p>
              </Col>
              <Col className="col-right">
                <p classname="text">
                  ...
                  bunden. Samtidigt er hun admin på flere af de danske
                  turneringer heriblandt OACES, Yousee Esportligaen og har
                  castet et par turneringer i både Rocket League, CS:GO og LoL.
                </p>
              </Col>
            </Row>
          </Container>
